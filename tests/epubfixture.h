...
inline void makeBook(const QString &path, bool broken, const QByteArray &version) {
    ...
    zip.addFile("OPS/Text/first.xhtml", QByteArray(R"(<html xmlns="http://www.w3.org/1999/xhtml"><head><link rel="stylesheet" href="../style.css"/></head><body><h1>Opening chapter</h1><p>Needle in the first chapter.</p><img src="../Images/pic%20one.png" width="100" height="60"/><p><a href="second.xhtml#closing">Next chapter</a></p></body></html>)"));
    if (!broken) zip.addFile("OPS/Text/second.xhtml", QByteArray(R"(<html xmlns="http://www.w3.org/1999/xhtml"><body><h1 id="closing">Closing chapter</h1><p>Another needle in the second chapter.</p></body></html>)"));
